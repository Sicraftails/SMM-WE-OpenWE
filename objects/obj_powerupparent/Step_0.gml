if (global.bg_level == "underwater" || (global.modo_noche == 1 && global.bg_level == "sky") || (global.modo_noche == 1 && global.bg_level == "airship") || (instance_exists(obj_lava_water) && y > (obj_lava_water.y + 16) && ((global.bg_level == "forest" && global.modo_noche == 0) || global.bg_level == "beach")))
    ...
    swimming = 0
if ((instance_exists(obj_lava_water) && y > obj_lava_water.y && global.bg_level == "castle") || (instance_exists(obj_lava_water) && y > obj_lava_water.y && global.bg_level == "forest" && global.modo_noche == 1) || (instance_exists(obj_lava_water) && y > obj_lava_water.y && global.bg_level == "mountain" && global.modo_noche == 1))
{
