...
draw_sprite_ext(sprite_index, image_index, x_draw, y_draw, s_scaley, s_scaley, rotacion, c_white, 1)
if (drag == 0)
    draw_sprite_ext(spr_button_change_skewer, 1, x, y, 1, 1, rotacion, c_white, 1)
