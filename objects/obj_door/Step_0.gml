if (keyboard_check(global.arriba) && instance_exists(obj_mario) && place_meeting(x, y, obj_mario) && get == 0 && obj_mario.state < 2 && obj_mario.inclown == 0 && visible == true && y > (obj_mario.y + 10) && y < (obj_mario.y + 17) && obj_mario.x >= x && obj_mario.x <= (x + 16))
{
