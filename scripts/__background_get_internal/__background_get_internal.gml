function __background_get_internal(argument0, argument1, argument2) {
	...
	if ((__backinfo[0] == -1)
		|| (layer_sprite_exists(__backinfo[1], __backinfo[0]) == false))	// this can happen when we change between backgrounds and foregrounds (because layers and elements get destroyed)
	{
